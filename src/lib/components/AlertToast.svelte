...
{#if alert}
<dialog onclick={() => dialogElement.close()} onclose={onClose} transition:fly={{y: -100, duration: 150}} class="flex-center alert-toast {alert.type}" open bind:this={dialogElement}>
