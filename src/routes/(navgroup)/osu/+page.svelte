...
<main class="flex-fill column" style="padding: 0 3.5%">
	...
	<span class="buttons-container">
		...
		<a class="search-button" href="" data-text="I'm feeling lucky" onclick={() => dialogElement.showModal()}>
			I'm feeling lucky
...
<style>
	...
	.search-button:is(:hover, :focus) {
		background: linear-gradient(130deg, var(--color-dark), var(--color-claret), var(--color-purple), var(--color-dark));
	}
