...
<main>
	...
	<ul>
		...
		<li>
			...
			<span class="description"
				>amount of scores gained in the last `gainedDays` days, undefined if not in previous ranking archive</span>
		</li>
		<li>
			<span>gainedRanks</span>
			<code class="type-type">number?</code>
			<span class="description"
				>amount of ranks gained in the last `gainedDays` days, undefined if not in previous ranking archive</span>
		</li>
		<li>
	...
	<ul>
		<li>
			<code class="type-type">{"PlayerInfo & { [ranking in RankingCategory]?: PlayerRanking }"}</code>
		</li>
	</ul>
